...
namespace WinGuiCommon
{
    ...
    public class WinGuiWpfDataContext : EditingContext,
            IListView,
            IItemView,
            IObservableContext,
            IInstancingContext,
            IEnumerableContext
    {
        ...
        /// <summary>
        /// Gets the context's ControlInfo</summary>
        public Sce.Atf.Wpf.Applications.ControlInfo ControlInfo
        {
        ...
        {
            get { return GetChildList<object>(Schema.winGuiCommonDataType.eventChild); }
        }
        ...
        public void GetInfo(object item, ItemInfo info)
        {
            ...
            info.ImageIndex = info.GetImageList().Images.IndexOfKey(WinGuiCommon.Resources.EventImage);
        ...
        private readonly System.Windows.Forms.ListView m_listView;
        private ListViewAdapter m_listViewAdapter;
        private Sce.Atf.Wpf.Applications.ControlInfo m_controlInfo;
    }
}
