...
{
    /// <summary>
    /// Adapter to make FSM printable</summary>
    public class PrintableDocument : DomNodeAdapter, IPrintableDocument
    {
        ...
        public PrintDocument GetPrintDocument()
        {
            ...
            if (s_printDocument == null)
                s_printDocument = new FsmPrintDocument();
        ...
        private static FsmPrintDocument s_printDocument;

        private class FsmPrintDocument : CanvasPrintDocument
        {
