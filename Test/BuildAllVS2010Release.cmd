...
echo.
echo ==== Building ATF VS 2010 - Release ====
echo.
pushd "%~dp0"
(
!DEVENV100! "Everything.vs2010.sln" /!VERB! "Release"
) || (echo. & echo **** Error building ATF VS 2010 Release **** & echo. & (IF %PAUSE%==true pause) & exit /b 1)
popd
