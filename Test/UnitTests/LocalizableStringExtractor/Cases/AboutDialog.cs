...
"
        ...
        public class TestLocalizedDescriptionAttribute
        {
            [LocalizedDescription("some LocalizedDescription string")]
            public string SomeString { get; set; }

            //[LocalizedDescription("unused LocalizedDescription string")] //test if it's commented-out
            public string SomeUnusedString { get; set; }

            [LocalizedDescription()] //test if there's no string
            public string EmptyDescriptionString { get; set; }
        }

        public class TestPropertyAttribute
        {
            [Property("the single arg property description")]
            public string SomeString { get; set; }

            [Property(sizeof(int), "the 4 arg property display name", sizeof(double), "the 4 arg property description")]
            public string SomeString { get; set; }

            //[Property("unused Property string")] //test if it's commented-out
            public string SomeUnusedString { get; set; }

            [Property()] //test if there's no string
            public string EmptyDescriptionString { get; set; }
        }
