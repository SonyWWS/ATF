...
#	Type.Outputs and Type.Inputs because those properties get the list of visible pins. --Ron
...
#Test.Equal( 5, G22.Type.Inputs.Count, "Verify the nested group has 5 inputs")
#Test.Equal( 4, G22.Type.Outputs.Count, "Verify the nested group has 4 outputs")
...
#Test.Equal( 4, A22.Type.Inputs.Count, "Verify the nested group has 4 inputs")
#Test.Equal( 2, A22.Type.Outputs.Count, "Verify the nested group has 2 outputs")

print("Step 8: grouping the top 2 groups")
G33 = CircuitEditorUtil.AddGroup([G22.DomNode , A22.DomNode], editingContext, grpCmds, "G33")
#Test.Equal( 7, G33.Type.Inputs.Count, "Verify the nested group has 7 inputs")
#Test.Equal( 6, G33.Type.Outputs.Count, "Verify the nested group has 6 outputs")

numElemsAfterEditing = circuitContainer.Elements.Count
numEdgesAfterEditing  = circuitContainer.Wires.Count

print("step 9: undo all edits")
while (hist.CanUndo):
    hist.Undo()
