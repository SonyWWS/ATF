...
{
    [TestFixture]
    public class UsingDomTests : TestBase
    {
        ...
        {
            //Launching this app saves a file to <pathToExe>\data\game.xml.
            //So delete that file if it exists, launch the app, then make sure the file was saved and is valid XML
            string gameXmlPath = Path.Combine(Path.GetDirectoryName(GetAppExePath()), "data\\game.xml");
