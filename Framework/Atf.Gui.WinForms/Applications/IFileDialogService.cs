...
namespace Sce.Atf.Applications
{
    ...
    public interface IFileDialogService
    {
        ...
        DialogResult OpenFileName(ref string pathName, string filter);
        ...
        /// <param name="filter">File extension filter, e.g., "Setting file (*.xml;*.txt)|*.xml;*.txt|Any (*.*)|*.*"</param>
        /// <returns>True iff operation is not cancelled</returns>
        DialogResult OpenFileNames(ref string[] pathNames, string filter);
        ...
        /// <param name="filter">File extension filter, e.g., "Setting file (*.xml;*.txt)|*.xml;*.txt|Any (*.*)|*.*"</param>
        /// <returns>True iff operation is not cancelled</returns>
        DialogResult SaveFileName(ref string pathName, string filter);
    ...
    public static class FileDialogServices
    {
        ...
        /// <returns>True iff operation is not cancelled</returns>
        public static DialogResult OpenFileName(this IFileDialogService service, ref string pathName, string filter, string directory)
        {
        ...
        /// <param name="directory">Directory that the user first sees, or null for default behavior</param>
        /// <returns>True iff operation is not cancelled</returns>
        public static DialogResult OpenFileNames(this IFileDialogService service, ref string[] pathNames, string filter, string directory)
        {
            string originalDir = service.ForcedInitialDirectory;
            try
            {
        ...
        /// <param name="directory">Directory that the user first sees, or null for default behavior</param>
        /// <returns>True iff operation is not cancelled</returns>
        public static DialogResult SaveFileName(this IFileDialogService service, ref string pathName, string filter, string directory)
        {
            string originalDir = service.ForcedInitialDirectory;
            try
            {
