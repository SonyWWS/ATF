...
namespace Sce.Atf.Wpf.Applications
{
    ...
    public class StandardEditCommands : ICommandClient, IContextMenuCommandProvider, IInitializable
    {
                ...
                if (s_useSystemClipboard)
                {
                    ...
                    try
                    {
                        ...
                        if (currentClipboardNum != s_clipboardNum)
                        {
                            ...
                            IDataObject systemClipboard = System.Windows.Clipboard.GetDataObject();
        ...
        bool ICommandClient.CanDoCommand(object tag)
        {
            ...
            var instancingContext = m_contextRegistry.GetActiveContext<IInstancingContext>();
