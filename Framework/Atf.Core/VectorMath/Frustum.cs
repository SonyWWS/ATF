...
namespace Sce.Atf.VectorMath
{
    ...
    public class Frustum : IFormattable
    {
        ...
        /// <summary>
        /// Returns the string representation of this Scea.VectorMath.Frustum structure 
        ...
        /// <returns>A <see cref="T:System.String"></see> representing the 3D viewing frustum</returns>
        public string ToString(string format, IFormatProvider formatProvider)
        {
            if (format == null && formatProvider == null)
                return Right.ToString("R") + ", " + Left.ToString("R") + ", " + Top.ToString("R") + ", " + Bottom.ToString("R") +
                    ", " + Near.ToString("R") + ", " + Far.ToString("R");

            return String.Format
            (
                 "({0}, {1}, {2}, {3}, {4}, {5})",
                 ((double)Right).ToString(format, formatProvider),
                 ((double)Left).ToString(format, formatProvider),
                 ((double)Top).ToString(format, formatProvider),
                 ((double)Bottom).ToString(format, formatProvider),
                 ((double)Near).ToString(format, formatProvider),
                 ((double)Far).ToString(format, formatProvider)
             );
        }
