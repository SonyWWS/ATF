...
namespace Sce.Atf.VectorMath
{
    ...
    public struct CircleF : IFormattable
    {
        ...
        /// <summary>
        /// Returns the string representation of this Scea.VectorMath.CircleF structure</summary>
        /// <returns>A <see cref="T:System.String"></see> representing the 2D circle</returns>        
        ...
        /// <summary>
        /// Returns the string representation of this Scea.VectorMath.CircleF structure 
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            if (format == null && formatProvider == null)
                return Center.X.ToString("R") + ",  " + Center.Y.ToString("R") + ",  " + Radius.ToString("R");
            else
