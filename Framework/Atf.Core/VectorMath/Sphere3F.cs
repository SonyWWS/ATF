...
namespace Sce.Atf.VectorMath
{
    ...
    public struct Sphere3F : IFormattable
    {
        ...
        /// <summary>
        /// Returns the string representation of this Scea.VectorMath.Sphere3F structure</summary>
        /// <returns> A <see cref="T:System.String"></see> representing the 3D sphere</returns>        
        ...
        /// <summary> 
        /// Returns the string representation of this Scea.VectorMath.Sphere3F structure 
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            if (format == null && formatProvider == null)
                return Center.X.ToString("R") + ",  " + Center.Y.ToString("R") + ",  " + Center.Z.ToString("R") +
                       ",  " + Radius.ToString("R");
            else
                ...
                (
                     ...
                     ((double)Center.Z).ToString(format, formatProvider),
