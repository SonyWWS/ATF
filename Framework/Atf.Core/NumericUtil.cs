...
namespace Sce.Atf
{
    ...
    public static class NumericUtil
    {
        ...
        /// <returns><c>True</c> if the number is zero</returns>
        ...
        /// <param name="value">The number to check</param>
        /// <returns><c>True</c> if the number is not a number, false if it is a number</returns>
        ...
        /// <returns><c>True</c> if the first number is greater than the second, false otherwise</returns>
        ...
        /// <param name="left">First number</param>
        /// <param name="right">Second number</param>
        /// <returns><c>True</c> if the first number is less than or close to the second, false otherwise</returns>
        ...
        /// <param name="left">First number</param>
        /// <param name="right">Second number</param>
        /// <returns><c>True</c> if the first number is close in value to the second</returns>
