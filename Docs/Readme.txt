...
* "Getting Started with ATF": Introduces ATF concepts and ATF samples.
...
* "ATF Programmer’s Guide: Document Object Model (DOM)": Shows how to use the ATF DOM for application data.
* "ATF API Reference": Complete reference to the ATF API. (CHM file).
* "ATF Curve Editor User and Programming Guide": A guide to using the ATF Curve Editor component and programming it.
